...
//  Copyright (c) 2014年 宋瑞旺. All rights reserved.
//
...
@interface GPPageScrollView() <UIScrollViewDelegate>
...
@implementation GPPageScrollView
...
- (void)setup
{
    ...
    // 设置页索引默认位置为右下角
    self.pageControlPostion = TPCPageControlPositionBottomCenter;
}
